...
# Mary profile
mary_profile = Profile.create(name: 'Mary Cutrali', birthday: '1990-07-29', bio: 'hacktastic', twitter: 'marycutrali', job_title: 'hacker', party_affiliation: 'Republican')
# Mary user
mary = User.create(:email => 'mary.cutrali@gmail.com', :password => 'mary', :profile => mary_profile)

# Travis profile
travis_profile = Profile.create(name: 'Travis Valentine', birthday: '1983-03-16', bio: 'stuff', twitter: 'travisvalentine', job_title: 'hacker', party_affiliation: 'Democrat')
# Travis user
